    ...
    return (
      <div className='max-w-4xl mx-auto py-6'>
        <p className='text-xl text-gray-300 leading-relaxed'>
          At ZEROGRAPHY PRODUCTION, we offer expert photography services for
          every need:
          ...
          - Professional headshots and personalized portraits that bring out
          your best.
          <span className='text-teal-400 font-medium'>
  ...
  return (
    <div className='min-h-screen bg-black'>
      ...
      <div className='max-w-[2000px] mx-auto px-4 py-8'>
        {/* Category Navigation */}
        <div className='flex flex-wrap justify-center gap-3 mb-12 bg-gray-900/50 p-4 rounded-2xl backdrop-blur-sm sticky top-4 z-10'>
